import{n as e,o as t}from"./chunk-zsgVPwQN.js";import{$ as n,Pt as r,cn as i,d as a,i as o,mt as s,pt as c,r as l,s as u,y as d}from"./iframe-CAjx62e_.js";var f,p,m,h,g,_=e((()=>{f=t(i(),1),o(),u(),p=r(),m={default:`bg-background text-foreground border-border`,success:`border-success/50 bg-success/10 text-success [&>svg]:text-success`,warning:`border-warning/50 bg-warning/10 text-warning-foreground [&>svg]:text-warning`,destructive:`border-destructive/50 bg-destructive/10 text-destructive [&>svg]:text-destructive`,info:`border-info/50 bg-info/10 text-info [&>svg]:text-info`},h={default:n,success:c,warning:d,destructive:s,info:n},g=f.forwardRef(({className:e,variant:t=`default`,title:n,onClose:r,children:i,...o},s)=>{let c=h[t];return(0,p.jsxs)(`div`,{ref:s,role:`alert`,className:l(`relative flex w-full items-start gap-3 rounded-lg border p-4`,m[t],e),...o,children:[(0,p.jsx)(c,{className:`mt-0.5 h-4 w-4 shrink-0`}),(0,p.jsxs)(`div`,{className:`flex-1 space-y-1`,children:[n&&(0,p.jsx)(`h5`,{className:`text-sm font-semibold leading-none tracking-tight`,children:n}),i&&(0,p.jsx)(`div`,{className:`text-sm opacity-90 [&_p]:leading-relaxed`,children:i})]}),r&&(0,p.jsx)(`button`,{onClick:r,className:`absolute right-3 top-3 rounded-md p-0.5 opacity-70 ring-offset-background transition-opacity hover:opacity-100 focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2`,"aria-label":`Close alert`,children:(0,p.jsx)(a,{className:`h-4 w-4`})})]})}),g.displayName=`Alert`,g.__docgenInfo={description:``,methods:[],displayName:`Alert`,props:{variant:{required:!1,tsType:{name:`union`,raw:`"default" | "success" | "warning" | "destructive" | "info"`,elements:[{name:`literal`,value:`"default"`},{name:`literal`,value:`"success"`},{name:`literal`,value:`"warning"`},{name:`literal`,value:`"destructive"`},{name:`literal`,value:`"info"`}]},description:``,defaultValue:{value:`"default"`,computed:!1}},title:{required:!1,tsType:{name:`string`},description:``},onClose:{required:!1,tsType:{name:`signature`,type:`function`,raw:`() => void`,signature:{arguments:[],return:{name:`void`}}},description:`Show a close button`}}}})),v=e((()=>{_()})),y,b,x,S,C,w,T,E,D;e((()=>{v(),y=r(),b={title:`Composites/Alert`,component:g,tags:[`autodocs`],argTypes:{variant:{control:`select`,options:[`default`,`success`,`warning`,`destructive`,`info`]}}},x={args:{variant:`info`,title:`Heads up!`,children:`You can add components to your app using the CLI.`}},S={args:{variant:`success`,title:`Success`,children:`Your changes have been saved successfully.`}},C={args:{variant:`warning`,title:`Warning`,children:`Your session is about to expire. Please save your work.`}},w={args:{variant:`destructive`,title:`Error`,children:`Something went wrong. Please try again.`}},T={args:{variant:`info`,title:`Dismissable`,children:`Click the X to close this alert.`,onClose:()=>alert(`Closed!`)}},E={render:()=>(0,y.jsxs)(`div`,{className:`space-y-4`,children:[(0,y.jsx)(g,{variant:`default`,title:`Default`,children:`Neutral information.`}),(0,y.jsx)(g,{variant:`info`,title:`Info`,children:`Informational note.`}),(0,y.jsx)(g,{variant:`success`,title:`Success`,children:`Operation completed.`}),(0,y.jsx)(g,{variant:`warning`,title:`Warning`,children:`Proceed with caution.`}),(0,y.jsx)(g,{variant:`destructive`,title:`Error`,children:`Action failed.`})]})},x.parameters={...x.parameters,docs:{...x.parameters?.docs,source:{originalSource:`{
  args: {
    variant: "info",
    title: "Heads up!",
