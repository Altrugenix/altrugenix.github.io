import{n as e}from"./chunk-jRWAZmH_.js";import{n as t,t as n}from"./altrugenix-feedback-D-7-5OYw.js";var r,i,a,o,s;e((()=>{t(),r={title:`Components/Feedback/TypingAnimation`,component:n,parameters:{layout:`centered`},tags:[`autodocs`]},i={args:{text:`Building the future of digital experiences 🚀`,speed:80}},a={args:{text:`Altrugenix: The only UI library you'll ever need.`,speed:50,className:`text-4xl md:text-5xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-600 to-indigo-600`}},o={args:{text:`Type... Repeat... Type... Repeat...`,speed:30,repeat:!0}},i.parameters={...i.parameters,docs:{...i.parameters?.docs,source:{originalSource:`{
  args: {
